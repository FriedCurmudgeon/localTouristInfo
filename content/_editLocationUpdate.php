...
if ($_SERVER['REQUEST_METHOD'] == 'POST' ) {
 ...
 $conn->updateLocation($id, $name, $name_no, $name_de, $name_es, $name_fr, $street, $zip, $city, $description, $description_no, $description_de, $description_es, $description_fr, $url, $lat, $lon, $img, $icon, $category);
...
<div class='card'>
  <div class="card-body">
    <h2 class='card-title'>Location is updated</h2>
    <p class='card-text'>
      <i class="fa-solid fa-check" style="color: #10cb14;"></i>
      The location "<?php echo $name; ?>" was successfully updated.</div>
    <br>
