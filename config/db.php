...
public function getGlobalSettings()
 ...
 public function updateGlobalSettings($id, $siteTitle, $siteTitle_no, $siteTitle_de, $siteTitle_es, $siteTitle_fr, $siteShortTitle, $siteShortTitle_no, $siteShortTitle_de, $siteShortTitle_es, $siteShortTitle_fr, $siteDescription, $siteDescription_no, $siteDescription_de, $siteDescription_es, $siteDescription_fr, $siteWelcomeTextToggle, $siteWelcomeTextTitle, $siteWelcomeTextTitle_no, $siteWelcomeTextTitle_de, $siteWelcomeTextTitle_es, $siteWelcomeTextTitle_fr, $siteWelcomeText, $siteWelcomeText_no, $siteWelcomeText_de, $siteWelcomeText_es, $siteWelcomeText_fr, $siteAllowSponsors, $siteAllowCoffee, $siteCoffeeLink, $siteCopyrightText, $siteCopyrightText_no, $siteCopyrightText_de, $siteCopyrightText_es, $siteCopyrightText_fr, $siteCopyrightName, $siteContactEmail)
 {
     ...
     echo $this->conn->error;
     $statement->bind_param('ssssssssssssssssssssssssssssssssssssi', $siteTitle, $siteTitle_no, $siteTitle_de, $siteTitle_es, $siteTitle_fr, $siteShortTitle, $siteShortTitle_no, $siteShortTitle_de, $siteShortTitle_es, $siteShortTitle_fr, $siteDescription, $siteDescription_no, $siteDescription_de, $siteDescription_es, $siteDescription_fr, $siteWelcomeTextToggle, $siteWelcomeTextTitle, $siteWelcomeTextTitle_no, $siteWelcomeTextTitle_de, $siteWelcomeTextTitle_es, $siteWelcomeTextTitle_fr, $siteWelcomeText, $siteWelcomeText_no, $siteWelcomeText_de, $siteWelcomeText_es, $siteWelcomeText_fr, $siteAllowSponsors, $siteAllowCoffee, $siteCoffeeLink, $siteCopyrightText, $siteCopyrightText_no, $siteCopyrightText_de, $siteCopyrightText_es, $siteCopyrightText_fr, $siteCopyrightName, $siteContactEmail, $id);
     $statement->execute();
     $statement->close();
 ...
 {
     $statement = $this->conn->prepare("INSERT INTO siteSettings (siteTitle, siteTitle_no, siteTitle_de, siteTitle_es, siteTitle_fr, siteShortTitle, siteShortTitle_no, siteShortTitle_de, siteShortTitle_es, siteShortTitle_fr, siteDescription, siteDescription_no, siteDescription_de, siteDescription_es, siteDescription_fr, siteWelcomeTextToggle, siteMaintenanceText_no, siteMaintenanceText_de, siteMaintenanceText_es, siteMaintenanceText_fr, siteWelcomeTextTitle, siteWelcomeTextTitle_no, siteWelcomeTextTitle_de, siteWelcomeTextTitle_es, siteWelcomeTextTitle_fr, siteWelcomeText, siteWelcomeText_no, siteWelcomeText_de, siteWelcomeText_es, siteWelcomeText_fr, siteAllowSponsors, siteAllowCoffee, siteCoffeeLink, siteCopyrightText, siteCopyrightText_no, siteCopyrightText_de, siteCopyrightText_es, siteCopyrightText_fr, siteCopyrightName, siteContactEmail) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
     echo $this->conn->error;
     $statement->bind_param('ssssssssssssssssssssssssssssssssssssssss', $siteTitle, $siteTitle_no, $siteTitle_de, $siteTitle_es, $siteTitle_fr, $siteShortTitle, $siteShortTitle_no, $siteShortTitle_de, $siteShortTitle_es, $siteShortTitle_fr, $siteDescription, $siteDescription_no, $siteDescription_de, $siteDescription_es, $siteDescription_fr, $siteWelcomeTextToggle, $siteWelcomeTextTitle, $siteWelcomeTextTitle_no, $siteWelcomeTextTitle_de, $siteWelcomeTextTitle_es, $siteWelcomeTextTitle_fr, $siteWelcomeText, $siteWelcomeText_no, $siteWelcomeText_de, $siteWelcomeText_es, $siteWelcomeText_fr, $siteAllowSponsors, $siteAllowCoffee, $siteCoffeeLink, $siteCopyrightText, $siteCopyrightText_no, $siteCopyrightText_de, $siteCopyrightText_es, $siteCopyrightText_fr, $siteCopyrightName, $siteContactEmail);
     $statement->execute();
     $statement->close();
     //$this->conn->close();
 }
